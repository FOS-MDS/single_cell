...
pbmc_v3.1k <- readRDS('./data/pbmc3k_Clust.rds')
v2.1k <- Read10X_h5("./data/pbmc_1k_v2_filtered_feature_bc_matrix.h5")
p3.1k <- Read10X_h5("./data/pbmc_1k_protein_v3_filtered_feature_bc_matrix.h5")
...
labels_v2.1k = read.delim('./data/celltypes_1k_v2.tsv', row.names = 1)
labels_p3.1k = read.delim('./data/celltypes_1k_protein.tsv', row.names = 1)
